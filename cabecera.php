      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
            <a class="nav-link" href="registro_cond.php">Datos Condominio</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="registro_inmueble.php">Registrar Inmueble</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="consulta_inmueble.php">Resumen de Inmuebles</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="registro_gastos.php">Ingresar Gastos</a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="consulta_gastos.php">Resumen de Gastos</a>
            </li>
            <li class="nav-item">
